...
function agregarPropiedad(objeto, property) {
  ...
  // objeto.property = null; tengo que usar la notacion de corchetes por que property es una variable, yo quiero que la propiedad
  // se llame como lo que hay en property, no property
